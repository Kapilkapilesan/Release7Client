                                ...
                                >
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-5">
                                            <div className="relative group-hover:scale-110 transition-transform">
                                                <div
                                                    className="w-12 h-12 rounded-[1rem] flex items-center justify-center font-black text-sm overflow-hidden border-2 border-border-default bg-muted-bg shadow-lg shadow-black/5"
                                                >
                                                    {record.avatar ? (
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col gap-1.5">
                                            <div className="flex items-center gap-3 px-4 py-2 bg-muted-bg border border-border-default rounded-2xl shadow-inner group-hover:border-primary-500/30 transition-colors">
