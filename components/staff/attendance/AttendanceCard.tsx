    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-start mb-8">
                <div className="flex items-center gap-5">
                    <div className="relative group-hover:scale-110 transition-transform">
                        <div
                            className="w-16 h-16 rounded-[1.5rem] flex items-center justify-center font-black text-xl border-2 border-border-default shadow-inner overflow-hidden bg-muted-bg"
                        >
                            {record.avatar ? (
            ...
            {record.status !== 'Leave' && !record.isOnline && (
                <div className="mb-6 px-6 py-3 bg-muted-bg/30 border border-border-default/50 rounded-2xl backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 gap-6">
                <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 px-6 py-4 bg-muted-bg border border-border-default rounded-2xl shadow-inner group-hover:border-primary-500/30 transition-colors">
