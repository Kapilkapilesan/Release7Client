        ...
        <div className="space-y-6">
            ...
            {isLoading ? (
                ...
                <div className="bg-card rounded-lg border border-border-default overflow-hidden shadow-sm">
                                        ...
                                        >
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    <div
                                                        className={`w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden shadow-sm`}
                                                        style={!user.avatar ? (user.status === 'Active' ? { backgroundColor: colors.primary[600], color: 'white' } : { backgroundColor: '#9CA3AF', color: 'white' }) : {}}
                                                    >
                                                        {user.avatar ? (
                                                            <img
                                                                src={user.avatar}
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex flex-col gap-0.5">
                                                    ...
                                                    {centerInfo !== '-' && (
                                                        <span className="text-xs text-text-muted flex items-center gap-1.5 pt-0.5">
                    ...
                    <div className="bg-input border-t border-border-divider px-6 py-3 flex items-center justify-between">
                        <p className="text-xs text-text-muted">
                            Showing <span className="font-medium text-text-primary">{filteredUsers.length}</span> entries
                        </p>
                    </div>
                </div>
            ) : (
