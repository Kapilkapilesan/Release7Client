            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                    <button
                        ...
                        className="flex items-center gap-2 text-white px-4 py-2 rounded-lg transition-all font-medium text-sm shadow-sm"
                    ...
                    <div className="relative flex-grow sm:flex-grow-0">
                        ...
                        <input
                            ...
                            className="w-full sm:w-64 pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 focus:outline-none transition-all"
                                ...
                                <tr key={request.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/30 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <div className="flex items-center gap-1.5 text-sm font-medium text-gray-900 dark:text-gray-100">
                                                <Calendar className="w-3.5 h-3.5" style={{ color: colors.primary[500] }} />
                                                <span>{request.startDate}</span>
                                            </div>
                                            <span className="text-xs text-gray-500 ml-5">to {request.endDate}</span>
                                            <div className="flex items-center gap-2 mt-1.5 ml-5">
                                                <span
                                                    className="text-[10px] font-black uppercase px-1.5 py-0.5 rounded border italic"
                                    ...
                                    <td className="px-6 py-4">
                                        <span
                                            ...
                                            style={
                                                request.status === 'Approved' ? { backgroundColor: colors.success[50], color: colors.success[600], borderColor: colors.success[100] } :
                                                    request.status === 'Rejected' ? { backgroundColor: colors.danger[50], color: colors.danger[600], borderColor: colors.danger[100] } :
                                                        { backgroundColor: colors.warning[50], color: colors.warning[600], borderColor: colors.warning[100] }
                                            }
                                        >
                                            {request.status}
                                        </span>
                                            ...
                                            {isAdmin && request.status === 'Pending' && (
                                                <>
                                                    <button
                                                        ...
                                                        onMouseEnter={(e) => e.currentTarget.style.backgroundColor = colors.success[50]}
