        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-gray-800 transition-all duration-300">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div className="flex items-center gap-5">
                    <button
                        onClick={onBack}
                        className="p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 group"
                        onMouseEnter={(e) => e.currentTarget.style.borderColor = colors.primary[300]}
                        onMouseLeave={(e) => e.currentTarget.style.borderColor = ''}
                    >
                        <ArrowLeft className="w-5 h-5 text-gray-400 transition-colors" style={{} as any} onMouseEnter={(e) => (e.currentTarget.style.color = colors.primary[600])} />
                    </button>
                    <div>
                        <h2 className="text-3xl font-[900] text-gray-900 dark:text-gray-100 tracking-tight leading-none mb-1">
                            Disbursement<span style={{ color: colors.primary[600] }}>.</span>
                        </h2>
                ...
                <div
                    ...
                    style={{ backgroundColor: colors.primary[50], color: colors.primary[700], borderColor: colors.primary[100] }}
                >
                    ...
                    <div className="bg-gray-100/50 dark:bg-gray-800/50 p-1.5 rounded-[1.2rem] inline-flex gap-1 w-full border border-gray-100 dark:border-gray-700/50 relative">
                        <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-2.5 py-3.5 px-4 rounded-xl text-sm font-bold transition-all duration-300 relative overflow-hidden ${salaryMode === 'ROLE'
                                ? 'bg-white dark:bg-gray-700 shadow-[0_4px_12px_-6px_rgba(0,0,0,0.1)] ring-1 ring-black/5 dark:ring-white/10'
                                : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-white/50'
                                }`}
                            style={salaryMode === 'ROLE' ? { color: colors.primary[600] } : {}}
                        >
                            <div className={`p-1 rounded-md transition-colors ${salaryMode === 'ROLE' ? '' : 'bg-gray-200 dark:bg-gray-700'}`} style={salaryMode === 'ROLE' ? { backgroundColor: colors.primary[100], color: colors.primary[600] } : {}}>
                        ...
                        <button
                            ...
                            style={salaryMode === 'INDIVIDUAL' ? { color: colors.primary[600] } : {}}
                        >
                            <div className={`p-1 rounded-md transition-colors ${salaryMode === 'INDIVIDUAL' ? '' : 'bg-gray-200 dark:bg-gray-700'}`} style={salaryMode === 'INDIVIDUAL' ? { backgroundColor: colors.primary[100], color: colors.primary[600] } : {}}>
                        ...
                        <button
                            ...
                            style={salaryMode === 'FILTER' ? { color: colors.primary[600] } : {}}
                        >
                            <div className={`p-1 rounded-md transition-colors ${salaryMode === 'FILTER' ? '' : 'bg-gray-200 dark:bg-gray-700'}`} style={salaryMode === 'FILTER' ? { backgroundColor: colors.primary[100], color: colors.primary[600] } : {}}>
