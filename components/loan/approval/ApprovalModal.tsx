                                        ...
                                        {isRejecting ? (
                                            ...
                                            <div className="flex justify-center gap-6">
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-3 px-12 py-4 bg-emerald-600 text-white font-black rounded-2xl hover:bg-emerald-700 shadow-xl shadow-emerald-500/30 transition-all transform hover:-translate-y-1 active:scale-95 disabled:opacity-75 disabled:cursor-not-allowed"
                                                >
                                                    {isProcessing ? (
                                                        <>
                                            ...
                                            {isRejecting ? (
                                                ...
                                                <div className="flex justify-center gap-6">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isProcessing}
                                                        className="flex items-center gap-3 px-12 py-4 text-white font-black rounded-2xl transition-all transform hover:-translate-y-1 active:scale-95 disabled:opacity-75 disabled:cursor-not-allowed"
