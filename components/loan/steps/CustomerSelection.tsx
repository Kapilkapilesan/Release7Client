                ...
                <div className="space-y-3">
                    ...
                    <div className="relative group/select">
                        <select
                            ...
                            className={`w-full pl-6 pr-12 py-4 bg-input border-2 rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-black tracking-tight appearance-none cursor-pointer ${formData.loanProduct ? 'border-primary-500/30 text-text-primary' : 'border-border-divider text-text-muted'}`}
                            style={{
                                '--tw-ring-color': `${colors.primary[500]}1A`
                            } as any}
                        >
                            <option value="" className="bg-card">Choose a protocol product</option>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative" ref={centerDropdownRef}>
                            <div
                                ...
                                className={`w-full pl-5 pr-12 py-4 bg-input border-2 rounded-2xl focus-within:ring-4 transition-all text-sm font-black tracking-tight cursor-pointer flex items-center justify-between ${formData.center ? 'border-primary-500/30 text-text-primary' : 'border-border-divider text-text-muted'}`}
                                style={{
                                    '--tw-ring-color': `${colors.primary[500]}1A`
                                } as any}
                            >
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative" ref={groupDropdownRef}>
                            <div
                                ...
                                className={`w-full pl-5 pr-12 py-4 bg-input border-2 rounded-2xl focus-within:ring-4 transition-all text-sm font-black tracking-tight flex items-center justify-between ${!formData.center ? 'bg-muted/50 cursor-not-allowed border-border-divider/30 opacity-40' : 'cursor-pointer'} ${formData.group ? 'border-primary-500/30 text-text-primary' : 'border-border-divider text-text-muted'}`}
                                style={{
                                    '--tw-ring-color': `${colors.primary[500]}1A`
                                } as any}
                            >
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative group/select">
                            <select
                                ...
                                className={`w-full pl-6 pr-12 py-4 bg-input border-2 rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-black tracking-tight appearance-none cursor-pointer disabled:bg-muted-bg/50 disabled:cursor-not-allowed disabled:opacity-40 ${formData.customer ? 'border-primary-500/30 text-text-primary' : 'border-border-divider text-text-muted'}`}
                                style={{
                                    '--tw-ring-color': `${colors.primary[500]}1A`
                                } as any}
                                disabled={!formData.center}
                            >
                                <option value="" className="bg-card">{formData.group ? 'Squad Members Only' : 'Station Registry'}</option>
                                {filteredCustomers.map((customer) => (
                                    <option key={customer.id} value={customer.id} className="bg-card">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        className={`w-full px-6 py-4 border-2 rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-black tracking-tight placeholder:text-text-muted/20 disabled:opacity-40 ${formData.guardian_nic && !isValidNIC(formData.guardian_nic) ? 'border-rose-500/50 bg-rose-500/5 text-rose-500 focus:ring-rose-500/10' :
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group/select">
                                    <select
                                        ...
                                        disabled={isAlreadyTaken && !selectedCustomerRecord.reloan_eligibility?.isEligible}
                                        className="w-full pl-6 pr-12 py-4 bg-input border-2 border-border-divider/50 rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-black tracking-tight appearance-none cursor-pointer disabled:opacity-40 text-text-primary"
                                        style={{ '--tw-ring-color': `${colors.primary[500]}1A` } as any}
                                        required
                                    >
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group/select">
                                    <select
                                        ...
                                        disabled
                                        className="w-full pl-6 pr-12 py-4 bg-muted-bg/40 border-2 border-border-divider/50 rounded-2xl text-sm font-black text-primary-500 appearance-none cursor-not-allowed opacity-80 shadow-inner"
                                    >
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group/select">
                                    <select
                                        ...
                                        disabled={isAlreadyTaken && !selectedCustomerRecord.reloan_eligibility?.isEligible}
                                        className={`w-full pl-6 pr-12 py-4 bg-input border-2 rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-black tracking-tight appearance-none cursor-pointer disabled:opacity-40 ${formData.witness2_id ? 'border-primary-500/30 text-text-primary' : 'border-border-divider text-text-muted'}`}
                                        style={{
                                            '--tw-ring-color': `${colors.primary[500]}1A`
                                        } as any}
                                    >
