            ...
            <div className="grid grid-cols-2 gap-8 bg-muted-bg/20 dark:bg-muted-bg/10 rounded-[2rem] border border-border-default p-8 transition-colors">
                ...
                <div className="space-y-3">
                    ...
                    <div className="relative">
                        ...
                        />
                        <p className="text-[9px] mt-2 px-2 font-black uppercase tracking-widest italic text-primary-500 opacity-60">Locked: Loan product default</p>
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full px-6 py-4 bg-muted-bg/40 border-2 border-border-divider/50 rounded-2xl text-base font-black text-text-muted/60 cursor-not-allowed shadow-inner"
                        />
                        <div className="absolute inset-y-0 right-6 flex items-center pointer-events-none text-text-muted/30">
                            <ChevronDown className="w-5 h-5" />
                        </div>
                        <p className="text-[9px] text-primary-500 mt-2 px-2 font-black uppercase tracking-widest italic opacity-60">Locked: System Policy</p>
                    </div>
                </div>
                ...
                <div className="col-span-2 md:col-span-1 space-y-3">
                    ...
                    <div className="relative group/select">
                        <select
                            ...
                            className={`w-full pl-6 pr-12 py-4 bg-input border-2 rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-black tracking-tight appearance-none cursor-pointer ${formData.tenure ? 'border-primary-500/30 text-text-primary' : 'border-border-divider text-text-muted'}`}
                            style={{ '--tw-ring-color': `${colors.primary[500]}1A` } as any}
                        >
                ...
                <div className="grid grid-cols-2 gap-8 bg-muted-bg/20 dark:bg-muted-bg/5 p-8 rounded-[2rem] border border-border-divider/50 shadow-inner">
                    <div className="col-span-2 md:col-span-1 space-y-3">
                        ...
                        <div className="relative group/select">
                            <select
                                ...
                                className="w-full pl-6 pr-12 py-4 bg-input border-2 border-border-divider/50 rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-black tracking-tight text-text-primary appearance-none cursor-pointer"
                                style={{ '--tw-ring-color': `${colors.primary[500]}1A` } as any}
                            >
                    ...
                    <div className="col-span-2 md:col-span-1 space-y-3">
                        ...
                        <input
                            ...
                            className="w-full px-6 py-4 bg-input border-2 border-border-divider/50 rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-black tracking-tight text-text-primary placeholder:text-text-muted/20"
            ...
            <div className="pt-10 border-t border-border-divider/30">
                ...
                <div className="relative group/textarea">
                    <textarea
                        ...
                        rows={4}
                        className="w-full px-8 py-6 bg-input border-2 border-border-divider/50 rounded-[2rem] focus:outline-none focus:ring-4 transition-all resize-none text-base font-black tracking-tight text-text-primary placeholder:text-text-muted/20"
                        style={{ '--tw-ring-color': `${colors.primary[500]}1A` } as any}
