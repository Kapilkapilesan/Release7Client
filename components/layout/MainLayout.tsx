...
function MainLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  > = {
    ...
    "/promotion-approval": {
      permissions: ["promotions.approve", "salary_increments.approve"],
    },
    "/temporary-promotion": {
      permissions: [
        "temporary_promotions.manage",
        "temporary_promotions.view",
        "temporarypromotions.view",
      ],
    },
    "/staff-promotion": {
      permissions: [
    ...
    "/staff-loans/approval": { permission: "staffloans.view" },
    ...
    "/maintenance/ip-whitelisting": { permission: "maintenance.view" },
  };
            ...
            <PermissionGuard
              permission={(() => {
                if (pathname === "/staff-management") {
                  ...
                  return hasAnyStaffAccess ? undefined : "staff.view";
                }

                if (routePermissions[pathname])
                  return routePermissions[pathname].permission;
