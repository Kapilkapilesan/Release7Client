        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
            <div className="p-5 border-b border-gray-200 bg-gradient-to-r from-green-50 to-emerald-50">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-gray-900">Profit Distribution Calculator</h3>
                ...
                {showDistribution && profitAmount > 0 && shareholders.length > 0 && (
                    <div className="mt-6 border-t border-gray-200 pt-6">
                        <div className="flex items-center justify-between mb-4">
                            <h4 className="text-sm font-semibold text-gray-900">Distribution Preview</h4>
                        ...
                        <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="text-sm">
                                    <p className="font-medium text-green-800">Distribution Formula</p>
