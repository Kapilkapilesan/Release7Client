        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {cards.map((card, index) => {
                ...
                return (
                    <div
                        key={index}
                        className="group relative bg-card border border-border-default p-5 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1 overflow-hidden"
                    >
