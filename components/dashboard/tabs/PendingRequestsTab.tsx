...
import { FileText, Calendar, DollarSign, Users, Edit3, Briefcase, ChevronRight, ArrowUpRight, Hash, Clock, Landmark, UserPlus, FileEdit } from 'lucide-react';
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1.5">
                                                ...
                                                <span className="text-[9px] font-bold text-text-muted uppercase tracking-widest opacity-60">
                                                    {section.type === 'loan' ? 'Credit Asset' : section.type === 'promotion' ? 'Rank Up' : 'Institutional'}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-6 relative z-10">
                                        <div className="text-right hidden sm:block">
                                            ...
                                            <p className="text-[13px] font-black text-text-primary tabular-nums tracking-tighter">
                                                {section.type === 'loan' || section.type === 'increment'
