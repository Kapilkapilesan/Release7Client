        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filteredBranches.map((branch) => (
                <div
                    ...
                    className="group relative bg-card rounded-[2rem] border border-border-default p-7 shadow-sm hover:shadow-2xl transition-all duration-500 cursor-pointer overflow-hidden transform hover:-translate-y-1"
                >
