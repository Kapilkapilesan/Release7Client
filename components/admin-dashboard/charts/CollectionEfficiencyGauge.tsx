            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
                ...
                <div className="flex items-center gap-4 bg-muted-bg p-1.5 rounded-2xl border border-border-default">
                    ...
                    <select
                        ...
                        className="px-4 py-2 text-sm font-bold border-none rounded-xl bg-card text-text-primary shadow-sm ring-1 ring-border-default focus:ring-2 focus:ring-blue-500 transition-all outline-none"
                    >
                        {branches.map((branch) => (
