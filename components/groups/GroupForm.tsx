                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6 bg-card">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full px-4 py-2.5 bg-input border border-border-default text-text-primary rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none text-sm placeholder:text-text-muted/40"
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                            className="w-full px-4 py-2.5 bg-input border border-border-default text-text-primary rounded-xl focus:ring-2 focus:ring-blue-500 transition-all outline-none appearance-none text-sm"
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 bg-input border border-border-default text-text-primary rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-sm placeholder:text-text-muted/40"
                                    />
                                </div>

                                {/* Customer Results List */}
                                <div className="border border-border-default rounded-2xl max-h-[220px] overflow-y-auto divide-y divide-border-divider shadow-sm bg-input">
                                    {isLoadingCustomers ? (
