                    ...
                    <div className="relative z-30 bg-white/80 backdrop-blur-xl p-6 rounded-3xl shadow-xl shadow-gray-200/50 border border-white">
                        ...
                        {!selectedCustomer ? (
                            <div className="relative group">
                                ...
                                <input
                                    type="text"
                                    className="w-full pl-12 pr-6 py-3.5 rounded-xl border-white border-[1.5px] outline-none transition-all shadow-lg shadow-gray-200/20 bg-white font-semibold text-sm text-gray-700 theme-focus-ring"
                            ...
                            <div className="col-span-2">
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        className="w-full px-5 py-3.5 rounded-xl border-white border-[1.5px] outline-none transition-all shadow-lg shadow-gray-200/20 bg-white font-bold text-gray-700 text-sm flex items-center justify-between theme-focus-ring"
                                    >
                            ...
                            {selectedProduct && (
                                <>
                                    ...
                                    <div>
                                        ...
                                        />
                                        <p className="text-[8px] text-gray-400 mt-2 font-black uppercase tracking-tight ml-1">Min: LKR {selectedProduct.min_amount.toLocaleString()}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div key={idx} className="flex flex-col gap-4 bg-gray-50/50 p-6 rounded-2xl border border-white shadow-sm animate-in slide-in-from-bottom-2 duration-300">
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                                            <div className="flex-1">
                                                ...
                                                <input type="text" placeholder="Enter full name" className="w-full px-4 py-2.5 rounded-lg border-white border-[1.5px] text-xs font-bold shadow-sm theme-focus-ring outline-none" value={nominee.name} onChange={e => updateNominee(idx, 'name', e.target.value)} />
                                            </div>
                                            <div className="flex-1">
                                                ...
                                                <select
                                                    className="w-full px-4 py-2.5 rounded-lg border-white border-[1.5px] text-xs font-bold shadow-sm theme-focus-ring outline-none bg-white cursor-pointer"
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-4 py-2.5 rounded-lg border-white border-[1.5px] text-xs font-bold shadow-sm theme-focus-ring outline-none"
                                                    value={nominee.nic}
