        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {statCards.map((card, index) => {
                ...
                return (
                    <div
                        key={index}
                        className="group bg-card/90 backdrop-blur-md p-4 rounded-2xl border border-border-default shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
                    >
                        <div className="flex items-center justify-between mb-3">
                            <div
                                className="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-500 group-hover:scale-105 shadow-sm"
                        ...
                        <div>
                            ...
                            <h3 className="text-lg font-black text-text-primary tracking-tight leading-none tabular-nums">{card.value}</h3>
