    ...
    return (
        <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: colors.surface.background }}>
            ...
            <div className="relative z-10 p-6 max-w-[1600px] mx-auto space-y-6 animate-in fade-in duration-700">
                {/* Modern Header */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/70 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-white/50">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-gray-900 tracking-tight uppercase leading-none">Finance Overview</h1>
                            <p className="text-[10px] text-gray-400 font-bold tracking-[0.3em] uppercase mt-2">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="hidden lg:flex flex-col items-end mr-4">
                            <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-none">Operating Status</span>
                        ...
                        <div className="flex items-center gap-2 bg-gray-50/50 p-1.5 rounded-2xl border border-gray-100">
                            <button className="flex items-center gap-2.5 px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 rounded-xl transition-all duration-300 shadow-sm border border-gray-100 font-black text-[10px] uppercase tracking-wider active:scale-95 group">
                                <Download className="w-3.5 h-3.5 text-gray-400 group-hover:text-primary-600 transition-colors" />
                                Export
                            </button>
                            <button
