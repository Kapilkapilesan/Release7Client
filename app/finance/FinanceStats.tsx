        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {cards.map((card, index) => {
                ...
                return (
                    <div
                        key={index}
                        className="group bg-white/80 backdrop-blur-md p-6 rounded-[2rem] border border-white shadow-xl shadow-gray-200/40 transition-all duration-500 hover:shadow-2xl hover:-translate-y-1"
                    >
                        <div className="flex items-center justify-between mb-6">
                            <div
                                className="w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-700 group-hover:scale-110 shadow-lg group-hover:rotate-3"
                                style={{
                        ...
                        <div>
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1.5 opacity-60">
                                {card.label}
                            </p>
                            <h3 className="text-2xl font-black text-gray-900 tracking-tighter tabular-nums">
                                {card.value}
                            </h3>
