                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    ...
                    {authService.hasPermission('loans.view') && (
                        <button
                            ...
                            disabled={importing}
                            className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-card border border-border-divider text-text-secondary px-6 py-2.5 rounded-xl hover:bg-hover transition-all shadow-sm font-bold text-xs uppercase tracking-widest disabled:opacity-50"
                        >
                    ...
                    {authService.hasPermission('loans.view') && (
                        <button
                            ...
                            className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-card border border-border-divider text-text-secondary px-6 py-2.5 rounded-xl hover:bg-hover transition-all shadow-sm font-bold text-xs uppercase tracking-widest"
                        >
